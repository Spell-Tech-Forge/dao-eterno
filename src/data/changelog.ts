...
export const CHANGELOG: PatchNote[] = [
  ...
  },
  {
    ...
    changes: [
      'Todos os 458 monstros (fase2 + legados) agora dropam receitas de forja T2-T10.',
      'Cobre todos os 10 tipos de arma (faixas, espada, sabre, lança, leque, bastão, arco, punhal, martelo, corrente).',
      'Cobre todos os 6 tipos de armadura e 5 tipos de acessório das novas classes.',
      'Admin: campo Subtipo no formulário de itens com dropdown completo para todas as classes.',
      'Admin: POST e PUT de itens agora salvam/atualizam subtype no banco.',
      'schema.sql: UPDATE de subtype expandido para cobrir bastão, arco, punhal, martelo, corrente, vestes, orbe, etc.',
      'Filtro de receitas por classe: .trim() nas comparações para evitar espaço acidental.',
    ],
  },
  {
    version: '0.38.12',
